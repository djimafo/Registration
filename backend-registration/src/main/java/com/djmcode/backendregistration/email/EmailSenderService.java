...
public class EmailSenderService implements EmailSender
{
  ...
  @Override
  @Async
  public void sendEmailConfirmation(String toEmail, String firstName, String subject, String link)
  {
    try
    {
      String emailBody = buildEmail(firstName,link);
  ...
  public void sendEmail(String toEmail, String emailBody, String subject, String attachment)
  {
    ...
    {
      MimeMessage mimeMessage = mailSender.createMimeMessage();
      MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true, "utf8mb4_0900_ai_ci");
      helper.setText(emailBody, true);
      helper.setTo(toEmail);
      helper.setSubject(subject);
      helper.setFrom("jerrymalcaire@yahoo.fr");
  ...
  private String buildEmail(String firstName, String confirmationLink) {
